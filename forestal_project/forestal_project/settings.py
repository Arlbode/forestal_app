"""
Django settings for forestal_project project.
...
SECRET_KEY = 'django-insecure-w@*i+)leit62zkat+%3fi9h2@@ff8pm-vvc7^6huw8k008ag6f'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']
CSRF_TRUSTED_ORIGINS = ['https://46f7-138-199-21-205.ngrok-free.app',]
